...
public class Utils {
    ...
    public static <C extends Enum<C>> boolean checkProductType(Class<C> productType, String productName) {
        for (Object object : productType.getEnumConstants()) {
            if (object.toString().equals(productName)) {
                return true;
            }
        }
        return false;
